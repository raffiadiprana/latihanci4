...
$routes->get('isi_berita', 'DashboardController::create');
$routes->get('schedule', 'DashboardController::schedule');
$routes->get('appoinment', 'DashboardController::appoinment');
$routes->post('berita_store', 'DashboardController::store');
$routes->get('edit_berita/(:num)', 'DashboardController::edit/$1');
$routes->post('update_berita/(:num)', 'DashboardController::update/$1');
