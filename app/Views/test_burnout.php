...
<body>
    <form class="py-5" method="POST" action="/test/burnout">
        <div class="container">
            ...
            <p class="mt-4">
                ...
                hubungan Anda dengan orang lain? Sejauh mana diri Anda secara pribadi terpenuhi?
            </p>
            <p class="mb-5 mt-4">
            ...
            <div class="px-5 mb-4">
                ...
                <div class="form-check">
                    <input class="form-check-input" value="0" type="radio" name="question-1" id="question-1">
                    <label class="form-check-label" for="question-1">
                        tidak Pernah
                    </label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" value="1" type="radio" name="question-1" id="question-1">
                    <label class="form-check-label" for="question-1">
                        jarang
                    </label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" value="2" type="radio" name="question-1" id="question-1">
                    <label class="form-check-label" for="question-1">
                        kadang-kadang
                    </label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" value="3" type="radio" name="question-1" id="question-1">
                    <label class="form-check-label" for="question-1">
                        cukup sering
                    </label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" value="4" type="radio" name="question-1" id="question-1">
                    <label class="form-check-label" for="question-1">
                        sangat sering
                    </label>
                </div>
            ...
            <div class="px-5 mb-4">
                ...
                <div class="form-check">
                    <input class="form-check-input" value="0" type="radio" name="question-2" id="question-2-1">
                ...
                <div class="form-check">
                    ...
                    <label class="form-check-label" for="question-2-4">
                        cukup sering
                    </label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" value="4" type="radio" name="question-2" id="question-2-5">
                    <label class="form-check-label" for="question-2-5">
                        sangat sering
                    </label>
                </div>
            </div>
            ...
            <div class="px-5 mb-4">
                ...
                <div class="form-check">
                    <input class="form-check-input" value="0" type="radio" name="question-3" id="question-3-1">
            ...
            <div class="px-5 mb-4">
                ...
                <div class="form-check">
                    <input class="form-check-input" value="0" type="radio" name="question-4" id="question-4-1">
                ...
                <div class="form-check">
                    ...
                    <label class="form-check-label" for="question-4-5">
                        sangat sering
                    </label>
                </div>
            </div>
            ...
            <div class="px-5 mb-4">
                ...
                <div class="form-check">
                    <input class="form-check-input" value="0" type="radio" name="question-5" id="question-5-1">
                ...
                <div class="form-check">
                    ...
                    <label class="form-check-label" for="question-5-4">
                        cukup sering
                    </label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" value="4" type="radio" name="question-5" id="question-5-5">
                    <label class="form-check-label" for="question-5-5">
                        sangat sering
                    </label>
                </div>
            </div>
