...
<div class="container mt-4">
  <div class="row">
    <div class="col-md-6">
      <a href="<?= site_url('admin/isi_berita') ?>" class="btn btn-primary">landing page</a>
    </div>I
  ...
  <?php foreach($berita as $key => $post) : ?>
    <div class="card my-3">
      <div class="card-body">
        ...
        <a href="<?= site_url('admin/edit_berita/' . $post['id']) ?>" class="btn btn-info">Edit</a>
        <a href="<?= site_url('admin/delete_berita/' . $post['id']) ?>" class="btn btn-danger">Delete</a>
      </div>
    </div>
  <?php endforeach ?>
</div>
