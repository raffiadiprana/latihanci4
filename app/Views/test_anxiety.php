...
<body>
    <form class="py-5" method="POST" action="/test/anxiety">
        <div class="container">
            ...
            <div class="px-5 mb-4">
                <h6>Saya merasa percaya diri</h6>
                <div class="form-check">
