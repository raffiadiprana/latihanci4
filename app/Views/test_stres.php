...
<body>
    <form class="py-5" method="POST" action="/test/stres">
        <div class=" container">
            ...
            <div class="px-5 mb-4">
                <h6>Seberapa sering anda merasa kesal karena memperoleh hal-hal tidak diharapkan yang terjadi?</h6>
            ...
            <div class="px-5 mb-4">
                <h6>Seberapa sering anda merasa bahwa anda tidak dapat mengendalikan hal-hal penting dalam hidup anda?</h6>
                <div class="form-check">
            ...
            <div class="px-5 mb-4">
                <h6>Seberapa sering anda merasa gugup dan stress?</h6>
                <div class="form-check">
            ...
            <div class="px-5 mb-4">
                <h6>Seberapa sering anda merasa tidak percaya diri mengenai kemampuan anda untuk mengatasi masalah pribadi?</h6>
                <div class="form-check">
            ...
            <div class="px-5 mb-4">
                <h6>Seberapa sering anda gagal dalam mengendalikan gangguan dalam hidup anda?</h6>
                <div class="form-check">
